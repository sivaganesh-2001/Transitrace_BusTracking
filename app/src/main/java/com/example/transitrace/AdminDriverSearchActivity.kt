...
class AdminDriverSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_driver_search)
        ...
        editTextDriverName = findViewById(R.id.editTextSearchDriver)
    ...
    private fun searchDriver(driverName: String) {
        ...
        query.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val adapter = ArrayAdapter(this@AdminDriverSearchActivity
